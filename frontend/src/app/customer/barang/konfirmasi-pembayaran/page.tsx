...
export default function KonfirmasiPembayaranBarangPage() {
  return (
    <div className="min-h-screen bg-white text-gray-800">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-white border-b px-4 py-4 flex items-center">
        <Link href="/customer/barang/konfirmasi">
      ...
      <div className="px-4 py-6 space-y-5">
        ...
        <div className="space-y-3">
          <Link
            href="/customer/barang/konfirmasi-pembayaran/bni"
          ...
          <Link
            href="/customer/barang/konfirmasi-pembayaran/bri"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
          ...
          <Link
            href="/customer/barang/konfirmasi-pembayaran/mandiri"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
              <Image
          ...
          <Link
            href="/customer/barang/konfirmasi-pembayaran/btn"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
