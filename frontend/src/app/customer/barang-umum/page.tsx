...
export default function BarangUmumSearchPage() {
      ...
      <div className="mt-[-20px] px-6 pb-20">
        <div className="bg-white rounded-xl shadow-lg p-5 space-y-5">
          ...
          <div className="space-y-1">
            ...
            <Link
              href={`/customer/barang-umum/pilih-lokasi?tipe=dari&dari=${encodeURIComponent(
                lokasiDari
          ...
          <div className="space-y-1">
            ...
            <Link
              href={`/customer/barang-umum/pilih-lokasi?tipe=ke&dari=${encodeURIComponent(
                lokasiDari
              )}&ke=${encodeURIComponent(lokasiKe)}&tanggal=${tanggal}&barang=${encodeURIComponent(
                detailBarang
              )}`}
          ...
          <div className="space-y-1">
            ...
            <Link
              href={`/customer/barang-umum/informasi?dari=${encodeURIComponent(
                lokasiDari
          ...
          <button
            onClick={() =>
              router.push(
                `/customer/barang-umum/hasil?dari=${encodeURIComponent(
                  lokasiDari
                )}&ke=${encodeURIComponent(lokasiKe)}&tanggal=${tanggal}&barang=${encodeURIComponent(
                  detailBarang
                )}`
