...
export default function KonfirmasiPembayaranBarangUmumPage() {
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="px-4 py-6 space-y-5">
        ...
        <div className="space-y-3">
          <Link
            href="/customer/barang-umum/konfirmasi-pembayaran/bni"
          ...
          <Link
            href="/customer/barang-umum/konfirmasi-pembayaran/bri"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
          ...
          <Link
            href="/customer/barang-umum/konfirmasi-pembayaran/mandiri"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
              <Image
          ...
          <Link
            href="/customer/barang-umum/konfirmasi-pembayaran/btn"
            className="flex items-center justify-between bg-white border rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3">
