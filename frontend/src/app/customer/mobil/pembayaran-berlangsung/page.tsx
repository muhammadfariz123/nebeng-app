  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 flex flex-col">
      ...
      <div className="flex justify-center items-center gap-2 mt-4">
        <div className="bg-gray-100 rounded-lg px-3 py-2 text-lg font-bold">{hh}</div>
        :
        <div className="bg-gray-100 rounded-lg px-3 py-2 text-lg font-bold">{mm}</div>
        :
        <div className="bg-gray-100 rounded-lg px-3 py-2 text-lg font-bold">{ss}</div>
      </div>
      ...
      {/* Detail perjalanan */}
      <div className="mx-4 mt-4 p-4 border rounded-lg">
        <p className="text-sm text-gray-500">Sabtu, 14 September 2024 • 07.00 - 09.30</p>
        <p className="mt-1 font-semibold">YOG POS 1 → SEM POS 3</p>
        <p className="text-sm text-gray-600">TOYOTA AVANZA</p>
        <p className="text-xs text-gray-500">3 Penumpang</p>
      </div>
