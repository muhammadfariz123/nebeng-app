...
export default function TambahPenumpangPage() {
  ...
  const handleSave = () => {
    ...
    const existing = localStorage.getItem("passengers");
    const passengers = existing ? JSON.parse(existing) : [];
    passengers.push(newPassenger);
    localStorage.setItem("passengers", JSON.stringify(passengers));

    router.push("/customer/mobil/pesan");
  };
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <div
            onClick={() =>
              router.push("/customer/mobil/penumpang/tipe-id")
            }
