    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="px-4 mt-6">
        ...
        <div className="flex justify-between text-sm text-gray-600">
          <span>YAMAHA NMAX</span>
          <span>Rp 110.000</span>
        </div>
        <div className="text-xs text-gray-500 mt-1">1 Penumpang (Orang x1)</div>
        ...
        <div className="flex justify-between items-center mt-4 p-3 bg-gray-100 rounded-lg">
          ...
          <span className="text-base font-bold text-gray-800">Rp. 110.000</span>
        </div>
      </div>
