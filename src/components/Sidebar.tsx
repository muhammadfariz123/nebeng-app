  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white shadow border-r border-gray-100 flex flex-col justify-between z-50">
      ...
      <div className="flex-1 overflow-y-auto">
        {/* Logo */}
        <div className="p-6 text-xl font-extrabold text-blue-600 tracking-tight text-center flex justify-center items-center">
          <img
            src="/nebeng.png"
            alt="Nebeng Logo"
       ...
       {/* Menu Navigasi */}
        <nav className="px-4 space-y-1 text-[15px] font-medium">
          ...
          >
            <AiFillHome className="text-[16px]" /> Beranda
          </button>
          ...
          <div>
            ...
            >
              <FaUser className="text-[16px]" /> Mitra
            {mitraOpen ? (
                <FaAngleUp className="ml-auto text-gray-400" />
              ) : (
                <FaAngleDown className="ml-auto text-gray-400" />
              )}
            </button>
            {mitraOpen && (
          ...
          >
            <HiUsers  className="text-[16px]" /> Customer
          </button>
          ...
          >
            <IoIosAlbums className="text-[16px]" /> Pesanan
          </button>
          ...
          >
            <BiSolidCreditCard className="text-[16px]" /> Refund
          </button>
          ...
          >
            <IoIosWarning className="text-[16px]" /> Laporan
          </button>
        </nav>
      </div>
      ...
      <div className="px-4 pb-4 space-y-2 text-sm">
        ...
        >
          <IoLogOut className="text-[16px]" /> Keluar
        </button>
      </div>
    </aside>
  );
